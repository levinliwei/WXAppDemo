...
Page({
  data: {
    ...
    item:'https://wx4.sinaimg.cn/crop.161.0.1422.800/006wxe7Lly1fy9qinznwxj318g0m8jty.jpg',
    showBarrage:['sdfsdf','deeee','dfsdfsdf']
  },
  ...
  barrageSwitch: function (e) {
    ...
    if (!e.detail.value) {
      ...
      //打开定时器
      timer = setInterval(this.barrageText_move, 200)
    }
  },
  ...
  getCommont:function(e) {
    ...
    //打开定时器
    timer = setInterval(this.barrageText_move, 500)
  ...
  getCommontddd: function (e) {
    ...
    barrage_style_obj = {
      // textWidth:textWidth,
      barrageText_height: barrageText_height,
      barrage_shootText: 'ddddddddddddd',
      barrage_shoottextColor: textColor,
      barrage_phoneWidth: phoneWidth
    };
    barrage_style_arr.push(barrage_style_obj);
